...
import com.harshit.goswami.musicplayer.databinding.FavouriteViewBinding

class FavorateAdapter(private val context: Context, private var musicList: ArrayList<Music>): RecyclerView.Adapter<FavorateAdapter.MyHolder>() {
