...
if(musicService?.mediaPlayer != null){
      ...
      if (intent.data?.scheme.contentEquals("content")){
          ...
          Glide.with(this)
              ...
              .apply(RequestOptions().placeholder(R.drawable.musical_note_icon2)).centerCrop().into(binding.playerImg)
      ...
      try {
       ...
       binding.timerBtn.setOnClickListener {
          ...
          }catch (e:Exception){Toast.makeText(this,"$e",Toast.LENGTH_SHORT).show() }
       }
    ...
    private fun setLayout(){
        ...
        if (min15 || min30  || min60) binding.timerBtn.setColorFilter(ContextCompat.getColor(this,R.color.purple_500))
    ...
    private fun createMediaPlayer() {
        ...
        if (musicService!!.mediaPlayer==null)musicService!!.mediaPlayer = MediaPlayer()
            ...
            binding.tvSeekBarStart.text = timeFormat(musicService!!.mediaPlayer!!.currentPosition.toLong())
    ...
    private fun getMusicDetails(contentUris: Uri): Music {
        ...
        try {
            ...
            return Music(id = "Unknown", album = "Unknown" ,title = path.toString(), artist = "Unknown", duration = duration, artUri = "Unknown", path = path.toString())
        }finally {
            cursor?.close()
        }
